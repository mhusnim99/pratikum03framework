...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group mt-4">
            <a href="<?php echo e(url('/boostrap_clone')); ?>" class="list-group-item list-group-item-action">
                    Boostrap CLone
            </a>
        </div>
...
<?php /**PATH C:\Users\Husni\Tugas03-framework\resources\views/routing.blade.php ENDPATH**/ ?>
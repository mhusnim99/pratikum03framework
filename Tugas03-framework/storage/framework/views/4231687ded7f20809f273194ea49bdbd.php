                ...
                <!--navbar brand-->
                    ...
                    <div class="offcanvas-body pt-0 px-4">
                        ...
                        <ul class="navbar-nav flex-row flex-wrap">
                            ...
                            <li class="nav-item col-6 col-md-auto"><a href="https://getbootstrap.com/docs/5.3/examples/" class="nav-link">Examples</a></li>
                            <li class="nav-item col-6 col-md-auto"><a href="https://icons.getbootstrap.com/" class="nav-link">Icons</a></li>
                            <li class="nav-item col-6 col-md-auto"><a href="https://themes.getbootstrap.com/" class="nav-link">Themes</a></li>
                            <li class="nav-item col-6 col-md-auto"><a href="https://blog.getbootstrap.com/" class="nav-link">Blog</a></li>
                        </ul>
...
<?php /**PATH C:\Users\Husni\Tugas03-framework\resources\views/boostrap_clone.blade.php ENDPATH**/ ?>